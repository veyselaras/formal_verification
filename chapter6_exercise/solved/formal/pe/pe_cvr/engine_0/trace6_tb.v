...
`endif
  ...
  always @(posedge clock) begin
    // state 1
    if (cycle == 0) begin
      PI_data_in_west <= 8'b01111111;
      PI_clear_acc <= 1'b0;
      PI_psum_in_north <= 32'b10000000000000000000000000000001;
      PI_weight_load <= 1'b1;
      PI_enable <= 1'b1;
      PI_reset <= 1'b0;
    end
    ...
    // state 2
    if (cycle == 1) begin
      PI_data_in_west <= 8'b10000000;
      PI_clear_acc <= 1'b0;
      PI_psum_in_north <= 32'b00000000000000000011111110000001;
      PI_weight_load <= 1'b0;
      PI_enable <= 1'b1;
      PI_reset <= 1'b0;
    end
