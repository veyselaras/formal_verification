...
`endif
    ...
    UUT.mem[3'b000] = 8'b00100110;
    UUT.mem[3'b001] = 8'b00000010;
    UUT.mem[3'b010] = 8'b00010000;
    UUT.mem[3'b011] = 8'b00000000;
    UUT.mem[3'b100] = 8'b10011101;
